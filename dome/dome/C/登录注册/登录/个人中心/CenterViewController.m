...
-(void)loadCellData{
    [NetworkObject postNetworkRequestWithUrlString:[NSString stringWithFormat:@"%@user/index",IP] parameters:@{@"Uid":@"62",@"Way":@"pass",@"token":[NetworkObject md5:@"bangbang"]} isCache:YES isUpdate:YES tableName:@"main" succeed:^(id data) {
        NSLog(@" ===\n %@",data);
    } fail:^(NSError *error) {
